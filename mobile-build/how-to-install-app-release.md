...
1. **Find the app-release.apk** file at:
   ```
   mobile-build\splash_screen_test\build\app\outputs\flutter-apk\app-release.apk
   ```
...
```bash
adb install mobile-build/splash_screen_test/build/app/outputs/flutter-apk/app-release.apk
```
